(function(){
function m(e,b,f,g){b.split(" ").forEach(function(b){e.addEventListener(b,f,g||!1)})}
function C(e,b,f,g){b.split(" ").forEach(function(b){e.removeEventListener(b,f,g||!1)})}
function M(){function e(){n=0;Z=K;D=N;x=M;O=Y;q.text=p.text=r=0;q.x=p.x=400;$=Date.now()/1E3 | 0;
...
function w(d) {
	var c = ja();
	0 < c.length && c.length > v.length / 2 && (d = ka(c, d), n += d.length, 
...
function da(e) {
	var b = "http://g.weiqimobile.com/games/bingtong/?f=wx&t=" + ((new Date).getTime() / 2E3 | 0);
	B("http://g.weiqimobile.com/icon/bt.jpg",
		b, "\u6211\u5728\u51b0\u6876\u6311\u6218\u6cfc\u4e86" + (typeof e == 'undefined' ? 0 : e) 
		+ "\u6876\u51b0\u6c34,\u8d85\u8fc7\u4e86" + k + "%\u4eba,\u5feb\u6311\u6218\u6211!\u653e\u5f03\u5c31\u53bb\u6350\u6b3e\u5427~",
		"\u5173\u6ce8\u808c\u840e\u7f29\u6027\u810a\u9ad3\u4fa7\u7d22\u786c\u5316\u75c7(ALS)\u75c5\uff0c\u53c2\u4e0e\u51b0\u6876\u6311\u6218\u6d3b\u52a8",
		"http://g.weiqimobile.com/")
}
var B;
! function() {
	var e = "",
...
var h = new createjs.LoadQueue(false, "img/");
h.loadManifest(K);
...
h.on("complete", function() {
	...
	m(b, "click", function L(h) {
		...
		f || (f = true, M(), _hmt.push(["_trackEvent", "button", "gameStart"]))
	});
