...
console.log("navigation init.1..");
console.log(localStorage['__APP_JS_STACK__' + window.location.pathname]);
console.log("navigation init.2..");
	...
	function navigate (handler, dragTransition) {
		...
		handler(function () {
			console.log("save stack in navigate")
			Stack.save();
