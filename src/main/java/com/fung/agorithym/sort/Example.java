...
import com.fung.tool.tookit.In;
import com.fung.tool.tookit.StdOut;

public class Example {

	public static void sort(Comparable[] a) { /*
											 * See Algorithms 2.1, 2.2, 2.3,
											 * 2.4, 2.5, or 2.7.
											 */
	}
	...
	public static void main(String[] args) { // Read strings from standard
		...
		String[] a={"couponRecord","allShopTotal","allTotal","allLastTotal","allDeliveryFee","allInvoiceFee","allGiveMoney","allImproveCost","allProductCount","discountCost","couponCode","mid"};
		sort(a);
