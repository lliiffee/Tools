...
*/
	...
	*/
	...
	//2.为门店申请设备数量。
	static String token="XrXOhzxxlzlGPjqqInGigIzH2VH22iTRTcP9xUN5_iR-3D-5QliwVtFkCO1HwpREYsh35MqAQH2vlWT_UZ3PF3KAvWVtnjzfQvql-aGRn_w";
 ...
 String json="{\"type\":\"image\",\"offset\":0,\"count\":20}";
	...
	//3 新增永久图文素材
		private static void  submitImage(){
			String postUrl="https://api.weixin.qq.com/cgi-bin/material/add_news?access_token=ACCESS_TOKEN";
	 String json="{" 
	...
	//添加摇一摇页面
	// curl -F media=@logo.png "https://api.weixin.qq.com/shakearound/material/add?access_token=2oUBEeGp4EFg8NpIes4Oz9wSKCNDWEb3w52KJB0vGExPE6PLaHk286UFKBuwvgY4l1brp-_pDWw2LoMTaIpMPull_fTLWL0xVKEUarLhtsQ&type=icon"	
	...
	private static void  submitPage(){
		...
		String json="{"
				+"\"title\":\"优惠券\","   
				+"\"description\":\"优惠大酬宾\","	
				+"\"page_url\":\"www.800pharm.com/shop/promo/promotion_4.html\","	
				//+"\"comment\":\"买药上八百方,正品保证！\","
				+"\"icon_url\":\"http://shp.qpic.cn/wx_shake_bus/0/1441086879e9dd2797018cad79186e03e8c5aec8dc/120\""
				+"}";
	...
	//{"data":{"page_id":392835},"errcode":0,"errmsg":"success."}  -->www.800pharm.com/shop/promo/promotion_3.html
	//{"data":{"page_id":392855},"errcode":0,"errmsg":"success."}  -->www.800pharm.com/shop/promo/promotion_4.html
	
	private  static   JSONObject  updateShakePageConfig(){
		String postUrl="https://api.weixin.qq.com/shakearound/page/update?access_token=ACCESS_TOKEN";
		String json="{"
				+"\"title\":\"八百方商城2\","   
				+"\"description\":\"八百方商城2\","	
				+"\"page_url\":\"http://www.800pharm.com/shop/m/\","	
				+"\"page_id\":250141,"
				+"\"icon_url\":\"http://p.qpic.cn/ecc_merchant/0/w_pic_1438247829683/0\""
				+"}";
		System.out.println(json);
		return WeiXinUtil.httpsRequest(postUrl.replace("ACCESS_TOKEN",token ) ,"POST", json) ;
		
	}	
	private static  JSONObject  getPageList(){
		String postUrl="https://api.weixin.qq.com/shakearound/page/search?access_token=ACCESS_TOKEN";
		String json="{"
			  + " \"type\": 2,"
			  +  " \"begin\": 0,"		
			  +  " \"count\": 3"
