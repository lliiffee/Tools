...
public class ComplexExportExcelClient {
	...
	public static void main(String[] args) {
		...
		sheet.addMergedRegion(new CellRangeAddress(2, (short) 2, 2, (short) aa));
		...
		for (int i = 2; i < number; i = i + 2) {
			sheet.addMergedRegion(new CellRangeAddress(3, (short) i, 3, (short) (i + 1)));
		...
		exportExcel.outputExcel("e:\\拒绝件统计.xls");
